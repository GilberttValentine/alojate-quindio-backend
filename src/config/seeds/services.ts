...
export async function seed(knex: Knex): Promise<void> {
  ...
  await knex("services").insert([
    ...
    { id: 29, name: "Refrigerador" },
    { id: 30, name: "Microondas" },
    { id: 31, name: "Utensilios para cocinar" },
    { id: 32, name: "Platos y cubiertos" },
    { id: 33, name: "Horno" },
    { id: 34, name: "Cafetera" },
    { id: 35, name: "Disponible para estadías largas" },
    { id: 36, name: "Acceso sin restricción de horario" },
    { id: 37, name: "Personal de edificio" },
    { id: 38, name: "Cámaras de seguridad" },
  ]);
}
